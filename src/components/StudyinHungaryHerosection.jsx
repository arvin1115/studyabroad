...
const slides = [
  {
    id: "welcome",
    src: "/src/assets/images/welcome.png", // (যেভাবে ছিল তেমনই)
  ...
  },
  {
    ...
    title: "Study in Hungary", // TODO: এখানে Country নাম বসান
  ...
  return (
    <div className="relative bg-black text-white">
      ...
      <div className="relative w-full h-[60vh] sm:h-[70vh] lg:h-[80vh]">
        ...
        <button
          onClick={prevSlide}
          className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-black/40 p-2 rounded-full hover:bg-black/70"
        >
          <FaChevronLeft size={24} />
        </button>
        <button
          onClick={nextSlide}
          className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-black/40 p-2 rounded-full hover:bg-black/70"
        >
